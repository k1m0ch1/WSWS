...
static u_char ngx_http_server_string[] = "Server: k1m0ch1-wawadukan" CRLF;
static u_char ngx_http_server_full_string[] = "Server: k1m0ch1-wawaduan-pisan-hayang-ningali-naon-maneh-didieu"; /* NGINX_VER CRLF; */
static u_char ngx_http_server_build_string[] = "Server: by k1m0ch1"; /* NGINX_VER_BUILD CRLF; */
